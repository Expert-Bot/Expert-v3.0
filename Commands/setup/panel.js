...
const j2c = require("../../Schemas/jointocreate");
const poll = require("../../Schemas/remind");
const remind = require("../../Schemas/remind");
...
const akaneko = require("../../Schemas/akaneko");
const nsfw = require("../../Schemas/nsfw");
